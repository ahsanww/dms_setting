                  ...
                  <div hidden class="form-group  ">
                    ...
                    <!-- <div hidden class="form-group ">
                      <label for="bay_name">Bay Name</label>
                        <input type="text" name="bay_name" id="bay_name" data-native-menu="false" val=" " class="form-control form-control-sm">
                        </input>
                    </div>
                    <div hidden class="form-group ">
                      <label for="bay_code">Bay Code</label>
                        <input type="text" name="bay_code" id="bay_code" data-native-menu="false" val=" "class="form-control form-control-sm">
                        </input>
                    </div>
                      -->
                    <div class="form-group">
