                ...
                <div class="tab-content" >  
                  ...
                  <form role="form" id ="form_update" method="post">
                    ...
                    <div class="form-group">
                     ...
                     <div <?php if($port_type=="0"){echo "hidden";}?> class="form-group">
                    ...
                    <div <?php if($port_type=="0"){echo "hidden";}?> class="form-group ">
                      <label for="location">Disturbance Folder</label>
                        <input type="text"  name="iec_file" id="iec_file" data-native-menu="false" class="form-control form-control-sm" value="<?php echo $iec_file;?>">
                        </input>
                    </div>
