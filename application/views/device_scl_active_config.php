            ...
            <div class="card card-success card-tabs">
              <div class="card-header p-0 pt-1">
                ...
                <li class="nav-item">
                  ...
                  <li <?php if($port_type=="0"){echo "hidden";} if($type=="add"){echo "hidden";} ?> class="nav-item iec " >
                  ...
                  <div class="card-body">
                      ...
                      <?php if($type=='add'){$data_type="";}?>
                        ...
                        <select name="data_type" id="data_type" name="data_type" data-native-menu="false" class="form-control form-control form-control-sm"> 
                          ...
                          <option value="bit-string" <?php if($data_type=="bit-string") echo 'selected="selected"'; ?>>bit-string</option>
                   ...
                   <br>
                      ...
                      <div id="intermediette" class="bit form-group b-str <?php if($data_type=="float" || $data_type=="integer" || $data_type=="boolean"){echo "d-none";}else{echo "";}?>" >
                        <label for="input_inter">Value :0</label>
                        <input type="text" class="form-control"  name="input_inter" placeholder="" value="<?php if($type=='edit'){echo $inter;}?>">
                      </div>

                      <div id="low" class="bit form-group <?php if($data_type=="float" || $data_type=="integer"){echo "d-none";}else{echo "";}?>" >
                        <label for="low" class="low_label"><?php if($data_type=="boolean") { echo "LOW Condition";}else {echo "Value :1";}?></label>
                        <input type="text" class="form-control"  name="low" placeholder="" value="<?php if($type=='edit'){echo $low;}?>">
                      </div>

                      <div id="high" class="bit form-group <?php if($data_type=="float" || $data_type=="integer"){echo "d-none";}else{echo "";}?>" >
                        <label for="input_unit" class="high_label"> <?php if($data_type=="boolean") { echo "HIGH Condition";}else {echo "Value :2";}?></label>
                        <input type="text" class="form-control"  name="high" placeholder="" value="<?php if($type=='edit'){echo $high;}?>">
                      </div>
                     
                      <div id="bad" class="bit form-group b-str <?php if($data_type=="float" || $data_type=="integer"  || $data_type=="boolean"){echo "d-none";}else{echo "";}?>" >
                        <label for="input_bad">Value:3</label>
                        <input type="text" class="form-control"  name="input_bad" placeholder="" value="<?php if($type=='edit'){echo $bad_state;}?>">
                      </div>
                      <div hidden class="form-group">
     ...
     $('#data_type').on('change',()=>{
      ...
      if(val=="integer" || val=="float"){
        $(`.bit`).addClass("d-none")
         ...
         if(val=="bit-string"){
          $(`.low_label`).text("Value:1")
          $(`.high_label`).text("Value:2")
          $(`.b-str`).removeClass("d-none")
         }
         else{
          $(`.low_label`).text("Low Condition")
          $(`.high_label`).text("High Condition")
           $(`.b-str`).addClass("d-none")
         }
