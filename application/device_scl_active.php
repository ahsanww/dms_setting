  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">SCL Activation</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../admin/dashboard">Home</a></li>
              <li class="breadcrumb-item active">SCL Activation</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <div class="card-header p-0 pt-1">
                ...
                <li class="nav-item">
                  ...
                  <li class="nav-item iec" >
                    <a class="nav-link " id="tab-SCL" data-toggle="pill" href="#custom-tabs-one-profile" onClick="toscl(<?php echo $_GET['id'].','.$_GET['no']?>)" role="tab" aria-controls="custom-tabs-one-profile" aria-selected="true">Generate SCL files &nbsp <i class=" text-white fa fa-search"></i></a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" id="list" data-toggle="pill" href="list" onClick="toactive()" role="tab" aria-controls="custom-tabs-one-messages" aria-selected="false">SCL Activation &nbsp <i class=" text-success fa fa-check"></i></a>
                  </li>
                </ul>
              </div>
              <div class="card-body">
                <div class="tab-content" >  
                 ...
                 <button class="btn btn-danger mb-3" onClick ="addsclconfig(<?php echo $_GET['id']?>,<?php echo $_GET['no']?>)">ADD SCL <i class="fas fa-plus"></i></button>
